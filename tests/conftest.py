...
@pytest.fixture
def in_area_list():
    return [{"Cuba": {"east": -73.9190004, "north": 23.4816972, "south": 19.6275294, "west": -85.1679702}}]
...
@pytest.fixture
def air_fly_1():
    return Airplane(country="Cuba", callsign="UPS496", origin_country="United States", velocity=194.9, altitude=305.87)
